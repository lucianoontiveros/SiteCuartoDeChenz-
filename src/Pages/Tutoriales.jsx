  ...
  return (
    <>
      <div className="tutoriales">
        <Card
          className="tutorial_card mb-2 mx-1 bg-dark text-xs xl:text-base text-green-200 sm:text-indigo-300 md:text-mintGreen xl:text-skyBlue hover:text-zinc-100"
        ...
        <Card className="tutorial_comandos p-0 bg-dark border-none">
          ...
          <p>
            ...
            misma quedará registrada y un mensaje vía chat avisará que se
          ...
          <p>
            ...
            Ingresando este comando se desplegará en pantalla la lista de tareas
            y también se expondrá en el chat. De no tener tareas registradas
            habrá un aviso informando la situación.
          </p>
          <p>
            <span className="bg-green-200 sm:bg-indigo-300 md:bg-mintGreen xl:bg-skyBlue hover:bg-zinc-100 text-green-800 font-medium me-2 px-2.5 py-0.5 rounded text-sm">
              {" "}
          ...
          <p>
            ...
            ingresando este comando se marcan todas las tareas. / by entering
            this command all tasks are marked.
          </p>
        </Card>
        ...
        <Card className="tutorial_comandos1 p-0 bg-dark border-none ">
          ...
          <p>
            ...
            Si ingresas tu fecha de nacimiento podremos automáticamente conocer
            tu signo. Próximamente, Brunito recordará si es tu cumpleaños.
            Importante no olvidar ingresar dos dígitos con el guion
            correspondiente. . Ej: !nacimiento 10-09
          </p>
