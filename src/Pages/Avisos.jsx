    ...
    <article className="articulo">
      ...
      <section className="articulo_aviso my-5 mx-5 text-xs xl:text-base  text-green-200 sm:text-indigo-300 md:text-mintGreen xl:text-skyBlue hover:text-zinc-100">
        ...
        <p className="mt-2">
          ...
          pese a que soy un papucho. Espero que estén teniendo un buen comienzo
          de actividades. Gracias una vez más por su compañía.
        </p>
        <p className="mt-2">
          Les Traigo el cronograma de las emisiones para estos días, luego de
          pasar un mes difícil por muchas cuestiones personales, quedando junio
          para acomodar sensaciones y retornar paulatinamente a la normalidad.
          Estaré todos los días en directo (Sin embargo, mi presencia se puede
          comprometer por algún corte de luz, que últimamente se está volviendo
          recurrente). Martes y miércoles haré oficina por la mañana, a
          excepción del jueves y viernes que me encontraré trabajando en casa
          con ustedes. A tener en cuenta que el miércoles tardaré en retornar al
          directo porque tengo que realizar un trámite.
        </p>
        <p className="mt-2">
        ...
        <ul className="mt-2 mb-2">
          ...
          <li>
            Miércoles: Tengo que realizar unos trasmites luego de trabajar, por
            lo cual voy a tardar en retornar al stream.
          </li>
          <li>Jueves: Trabajo en casa jornada completa con ustedes </li>
          <li>
            Viernes: Trabajo en casa, jornada completa con ustedes jornada para
            enfocarte, quizás sea una buena opción.
          </li>
          <li>
        ...
        <p className="mt-3">
          Sin mucho más que decir, les mando un abrazo y estoy a su disposición
