    ...
    <div className="tutorial_card1 ">
          ...
          <Card className={card_styles} horizontal>
            ...
            <p>
              ...
              regaladas a BrunitoPet. Recuerda no ingresar el @, simplemente el
              nombre del usuario. Ej !verusuario cuartodechenz
            </p>
          </Card>
          ...
          <Card className={card_styles} horizontal>
            ...
            <div>
              <p className="">
                ...
                concentración, se mostrará en pantalla un cuanto regresiva, que
                al finalizar emitará un sonido de trueno, con un posterior
                mensaje de Brunitopet indicando que tu tiempo de concentración
                terminó. Ejemplo: para 30 minutos puedo ingresar !focus 30.
              </p>
            </div>
          </Card>
        </div>
